...
?>
                ...
                ?>
                    ...
                    <?php
                        ...
                        case 'prepagas':
                            ?>
                                <form action="" method="post">
                                    <input type=hidden name=altaPrepaga>
                                    <label for="prepaga">Descipcion: </label>
                                    <input type="text" name="prepaga">
                                    <br>
                                    <input type="submit" value="Dar de alta Obra Social">
                                </form>
                            <?php
                                break;
                    case 'usuarios':
    ...
    if (isset($_POST['altaPrepaga'])) {
        $prepaga = $_POST['prepaga'];

        $sql = "insert into $tabla (desc_prepaga) values ('$prepaga');";
        ...
        if (mysqli_affected_rows($cn) > 0) {
            echo "<p>El prepaga $prepaga fue cargada con éxito</p>";
            Header("Location: usuario.php?creado");
        }
        mysqli_close($cn);
    }
